...
export const TimelineStep = ({ index, text, completed, onToggle }) => {
    return (
        <div className="relative">
            {/* Step Icon: CRITICAL FIX: The left position is now -55px to pull the circle (which is 40-48px wide) 
               out of the pl-20 (5rem = 80px) padding of the parent container, centering it precisely over the line. */}
            <div className="absolute left-[-55px] top-0 flex items-center justify-center w-10 h-10 md:w-12 md:h-12">
            ...
            <div
                // Step Card: The outer div handles the positioning, so this content div is clean.
                className={`p-5 md:p-6 rounded-xl border transition cursor-pointer ${
                    completed
